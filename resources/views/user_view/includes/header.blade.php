<header class="bg-gradient-dark">
  <div class="page-header min-vh-100" style="background-image: url('frontend/assets/img/PPDB/13.jpeg');">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center mx-auto my-auto">
          ...
          <h2 class=" mb-4 text-white opacity-9">SMPIT Nurul 'Ilmi Tenggarong</h2>
